...
export default function VerifyPage() {
  ...
  const handleGoogleSuccess = (credentialResponse: any) => {
    try {
      ...
      // For real YouTube API access, you would need to exchange this for an access token
      // This is a simplified demo - in production, use Google Sign-In library properly
    } catch (error) {
